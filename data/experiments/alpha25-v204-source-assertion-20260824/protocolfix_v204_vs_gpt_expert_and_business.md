...
- Business GT unique loose F1: **0.484**; final v5: **0.319**.
- Business GT unique strict F1: **0.170**; final v5: **0.205**. Strict matching additionally requires compatible owner/state/condition.
- Business GT unique core-tensile loose F1: **0.841**; final v5: **0.769**.
...
| final_v5 | Properties | 184 | 363 | 617 | 0.507 | 0.298 | 0.376 |
| final_v5 | **micro** | 481 | 1610 | 3093 | 0.299 | 0.156 | 0.205 |
| final_v5 | **unique core tensile** | 123 | 159 | 213 | 0.774 | 0.577 | 0.661 |
...
| final_v5 | Properties | 248 | 363 | 617 | 0.683 | 0.402 | 0.506 |
| final_v5 | **micro** | 751 | 1610 | 3093 | 0.466 | 0.243 | 0.319 |
| final_v5 | **unique core tensile** | 143 | 159 | 213 | 0.899 | 0.671 | 0.769 |
...
| final_v5 | Properties | 185 | 363 | 626 | 0.510 | 0.296 | 0.374 |
| final_v5 | **micro** | 536 | 1665 | 3286 | 0.322 | 0.163 | 0.217 |
| final_v5 | **unique core tensile** | 123 | 159 | 213 | 0.774 | 0.577 | 0.661 |
...
| final_v5 | Properties | 249 | 363 | 626 | 0.686 | 0.398 | 0.504 |
| final_v5 | **micro** | 804 | 1665 | 3286 | 0.483 | 0.245 | 0.325 |
| final_v5 | **unique core tensile** | 143 | 159 | 213 | 0.899 | 0.671 | 0.769 |
...
| final_v5 | `condition_conflict` | 42 |
| final_v5 | `expert_gt_missing_or_unsupported` | 715 |
| final_v5 | `system_missing` | 2482 |
| final_v5 | `unit_conflict` | 32 |
| final_v5 | `value_conflict` | 114 |
| final_v5 | `wrong_owner` | 226 |
...
| final_v5 | unique loose micro | 0.318 | 0.319 | +0.001 |
| final_v5 | unique strict micro | 0.203 | 0.205 | +0.002 |
| final_v5 | unique core tensile | 0.765 | 0.769 | +0.003 |
