...
- Business GT unique loose F1: **0.411**; final v5: **0.281**.
- Business GT unique strict F1: **0.143**; final v5: **0.123**. Strict matching additionally requires compatible owner/state/condition.
...
| final_v5 | Processing | 101 | 790 | 553 | 0.128 | 0.183 | 0.150 |
...
| final_v5 | **micro** | 591 | 6526 | 3093 | 0.091 | 0.191 | 0.123 |
...
| final_v5 | Processing | 237 | 790 | 553 | 0.300 | 0.429 | 0.353 |
...
| final_v5 | **micro** | 1350 | 6526 | 3093 | 0.207 | 0.436 | 0.281 |
...
| final_v5 | Processing | 127 | 888 | 650 | 0.143 | 0.195 | 0.165 |
...
| final_v5 | **micro** | 646 | 6795 | 3286 | 0.095 | 0.197 | 0.128 |
| final_v5 | **unique core tensile** | 83 | 420 | 222 | 0.198 | 0.374 | 0.259 |
...
| final_v5 | Processing | 291 | 888 | 650 | 0.328 | 0.448 | 0.378 |
...
| final_v5 | **micro** | 1431 | 6795 | 3286 | 0.211 | 0.435 | 0.284 |
| final_v5 | **unique core tensile** | 155 | 420 | 222 | 0.369 | 0.698 | 0.483 |
...
| final_v5 | `expert_gt_missing_or_unsupported` | 4662 |
| final_v5 | `system_missing` | 1855 |
| final_v5 | `unit_conflict` | 199 |
| final_v5 | `value_conflict` | 501 |
| final_v5 | `wrong_owner` | 646 |
...
| final_v5 | unique loose micro | 0.280 | 0.281 | +0.001 |
| final_v5 | unique strict micro | 0.120 | 0.123 | +0.002 |
