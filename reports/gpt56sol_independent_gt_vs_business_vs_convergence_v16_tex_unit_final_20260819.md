...
- Business GT unique loose F1: **0.371**; final v5: **0.247**.
- Business GT unique strict F1: **0.128**; final v5: **0.112**. Strict matching additionally requires compatible owner/state/condition.
...
| final_v5 | Processing | 75 | 781 | 555 | 0.096 | 0.135 | 0.112 |
...
| final_v5 | **micro** | 538 | 6517 | 3095 | 0.083 | 0.174 | 0.112 |
...
| business_gt | Processing | 194 | 821 | 555 | 0.236 | 0.350 | 0.282 |
...
| final_v5 | **micro** | 1185 | 6517 | 3095 | 0.182 | 0.383 | 0.247 |
...
| final_v5 | Processing | 87 | 877 | 650 | 0.099 | 0.134 | 0.114 |
...
| final_v5 | **micro** | 578 | 6784 | 3286 | 0.085 | 0.176 | 0.115 |
| final_v5 | **unique core tensile** | 83 | 420 | 222 | 0.198 | 0.374 | 0.259 |
...
| business_gt | Processing | 231 | 1757 | 650 | 0.131 | 0.355 | 0.192 |
...
| business_gt | **micro** | 1313 | 5117 | 3286 | 0.257 | 0.400 | 0.313 |
| business_gt | **unique core tensile** | 172 | 255 | 222 | 0.675 | 0.775 | 0.721 |
| final_v5 | Composition | 529 | 1001 | 875 | 0.528 | 0.605 | 0.564 |
| final_v5 | Processing | 184 | 877 | 650 | 0.210 | 0.283 | 0.241 |
...
| final_v5 | **micro** | 1242 | 6784 | 3286 | 0.183 | 0.378 | 0.247 |
| final_v5 | **unique core tensile** | 155 | 420 | 222 | 0.369 | 0.698 | 0.483 |
...
| business_gt | `expert_gt_missing_or_unsupported` | 3248 |
| business_gt | `system_missing` | 1973 |
| business_gt | `unit_conflict` | 160 |
| business_gt | `value_conflict` | 394 |
| business_gt | `wrong_owner` | 781 |
| final_v5 | `condition_conflict` | 103 |
| final_v5 | `expert_gt_missing_or_unsupported` | 4740 |
| final_v5 | `system_missing` | 2044 |
| final_v5 | `unit_conflict` | 180 |
| final_v5 | `value_conflict` | 620 |
| final_v5 | `wrong_owner` | 561 |
...
|---|---|---:|---:|---:|
| business_gt | unique loose micro | 0.367 | 0.371 | +0.004 |
| business_gt | unique strict micro | 0.125 | 0.128 | +0.003 |
| business_gt | unique core tensile | 0.718 | 0.721 | +0.003 |
| final_v5 | unique loose micro | 0.246 | 0.247 | +0.001 |
| final_v5 | unique strict micro | 0.109 | 0.112 | +0.003 |
